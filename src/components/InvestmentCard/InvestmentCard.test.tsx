...
describe("InvestmentCard Component Unit Tests", () => {
  ...
  test("should show investmentName", () => {
    const investmentCardComponent = render(<InvestmentCard investmentName="Test Fund" profit="5000 TL" profitPercentage="5" />);
    const investmentCardChildren = investmentCardComponent.getByTestId("investmentName").children;
  ...
  test("should show profit", () => {
    const investmentCardComponent = render(<InvestmentCard investmentName="Test Fund" profit="5000 TL" profitPercentage="5" />);
    const investmentCardChildren = investmentCardComponent.getByTestId("profit").children;
  ...
  test("should show profit percentage", () => {
    const investmentCardComponent = render(<InvestmentCard investmentName="Test Fund" profit="5000 TL" profitPercentage="5" />);
    const investmentCardChildren = investmentCardComponent.getByTestId("profitPercentage").children;
  ...
  test("should be pressed", () => {
    ...
    const investmentCardComponent = render(<InvestmentCard investmentName="Test Fund" profit="5000 TL" profitPercentage="5" onPress={mockFunction} testOnly_pressed />);
